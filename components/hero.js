...
import heroImg from "../public/img/masters.gif";
        ...
        <div className="flex items-center ">
          <div className="max-w-2xl mb-8">
            ...
            <p className="py-5 text-xl leading-normal text-gray-500 lg:text-xl xl:text-2xl dark:text-gray-300">
              AI Interfacing, easy integrations and business dynamic improvements based on AI Insights.
              Start your AI Business Extension.
            </p>

            <div className="flex flex-col items-start space-y-3 sm:space-x-4 sm:space-y-0 sm:items-center sm:flex-row">
              <a href="/ai" className="relative inline-flex items-center px-12 py-3 overflow-hidden text-lg font-medium text-zinc-300 border-2 border-black rounded-full hover:text-white group hover:bg-neutral-800">
          ...
          <span class="relative">Demo AI</span>
          </a>
              <a
                href="/ai"
                target=""
      ...
      <Container>
        <div className="flex flex-col justify-center">
          <div className="text-xl text-center text-gray-700 dark:text-white">
            Online since: <span className="text-blue-800">{new Date().getFullYear()}</span>{" "}
          </div>
