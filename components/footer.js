...
export default function Footer() {
  const [timer, setTimer] = React.useState(9328833);
      ...
      <Container>
        <div className="grid max-w-screen-xl grid-cols-1 gap-10 pt-10 mx-auto mt-5 border-t border-gray-100 dark:border-trueGray-700 lg:grid-cols-5">
          <div className="lg:col-span-2">
            ...
            <div className="mt-5">
              <a
                href="https://github.com/valeriuhudea/aimasters"
                target="_blank"
                rel="noopener"
          ...
          <div className="">
            ...
            <div className="flex mt-5 space-x-5 text-gray-400 dark:text-gray-500">
              <a
                href="https://twitter.com/aimasters"
                target="_blank"
                rel="noopener">
              ...
              <a
                href="https://facebook.com/aimasters"
                target="_blank"
                rel="noopener">
              ...
              <a
                href="https://instagram.com/aimasters"
                target="_blank"
                rel="noopener">
        ...
        <div className="my-10 text-sm text-center text-gray-600 dark:text-gray-400">
          Copyright © {new Date().getFullYear()} aimasters.us - powered by ♥ and free runs: {timer} from {" "}
          <a
            href="https://github.com/valeriuhudea"
            target="_blank"
            rel="noopener">
            Valeriu Hudea.
          </a>
